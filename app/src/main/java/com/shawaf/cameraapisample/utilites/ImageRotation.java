...
/**
 * Created by Shawaf on 1/15/2017.
 */
...
public class ImageRotation {
    ...
    public static ImageRotation getInstance(Context co0ntext){
        context=co0ntext;
    ...
    public void rotateImage(String file) throws IOException {
        ...
        int rotationAngle = getCameraPhotoOrientation(context, Uri.parse(file), file);
